# Nombre del Archivo: 03_Nivel_3_Metricas.py
# Descripción: Página del Nivel 3 - Métricas - Análisis de datos
...
def main():
    ...
    # UI - Agregar Conexion con Niveles Anteriores
    create_info_box(
        "info-box",
    ...
    # UI - Reforzar Concepto de Tipos de Datos
    create_info_box(
        "info-box",
